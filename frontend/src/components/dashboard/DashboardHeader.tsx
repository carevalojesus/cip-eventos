...
export const DashboardHeader: React.FC<DashboardHeaderProps> = ({
    ...
    return (
        <header
            className={`rui-navbar ${onMenuClick ? "has-menu-toggle" : ""}`}
        >
            ...
            <div className="rui-navbar-content">
                ...
                <button
                    className="rui-notification-button"
                    aria-label="Notificaciones"
                >
                    <Bell size={20} />
                    {hasNotifications && (
                        <span className="rui-notification-badge" />
                    )}
                </button>
                    ...
                    <DropdownMenuTrigger asChild>
                        <div className="rui-user-profile">
                            ...
                            <div className="rui-user-info hidden sm:flex">
                                <span className="rui-user-name">
                                    {getUserDisplayName()}
                                </span>
                                <span className="rui-user-role">
