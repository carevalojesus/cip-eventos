...
export const AvatarEditor: React.FC<AvatarEditorProps> = ({
    ...
    const validateFile = (file: File): string | null => {
        if (!ACCEPTED_TYPES.includes(file.type)) {
            return t(
                "users.avatar.invalid_type",
                "Formato no válido. Use PNG, JPG o WebP."
            );
        }
        if (file.size > MAX_SIZE_BYTES) {
            return t(
                "users.avatar.too_large",
            ...
            {showRemoveConfirm && (
                ...
                >
                    ...
                    >
                        ...
                        >
                            {t(
                                "users.avatar.remove_description",
                                "La foto de perfil será eliminada. Esta acción no se puede deshacer."
                            )}
                        </p>
